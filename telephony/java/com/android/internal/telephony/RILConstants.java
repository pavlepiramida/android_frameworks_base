...
*/
    ...
    int RIL_UNSOL_RESPONSE_BASE = 1000; 							// 0X3e8
    int RIL_UNSOL_RESPONSE_RADIO_STATE_CHANGED = 1000;				// 0X3e8
    int RIL_UNSOL_RESPONSE_CALL_STATE_CHANGED = 1001;				// 0x3e9
    int RIL_UNSOL_RESPONSE_VOICE_NETWORK_STATE_CHANGED = 1002;		// 0x3ea
    int RIL_UNSOL_RESPONSE_NEW_SMS = 1003;							// 0x3eb
    int RIL_UNSOL_RESPONSE_NEW_SMS_STATUS_REPORT = 1004;			// 0x3ec
    int RIL_UNSOL_RESPONSE_NEW_SMS_ON_SIM = 1005;					// 0x3ed
    int RIL_UNSOL_ON_USSD = 1006;									// 0x3ee
    int RIL_UNSOL_ON_USSD_REQUEST = 1007;							// 0x3ef
    int RIL_UNSOL_NITZ_TIME_RECEIVED = 1008;						// 0x3f0
    int RIL_UNSOL_SIGNAL_STRENGTH = 1009;							// 0x3f1
    int RIL_UNSOL_DATA_CALL_LIST_CHANGED = 1010;					// 0x3f2
    int RIL_UNSOL_SUPP_SVC_NOTIFICATION = 1011;						// 0x3f3
    int RIL_UNSOL_STK_SESSION_END = 1012;							// 0x3f4
    int RIL_UNSOL_STK_PROACTIVE_COMMAND = 1013;						// 0x3f5
    int RIL_UNSOL_STK_EVENT_NOTIFY = 1014;							// 0x3f6
    int RIL_UNSOL_STK_CALL_SETUP = 1015;							// 0x3f7
    int RIL_UNSOL_SIM_SMS_STORAGE_FULL = 1016;						// 0x3f8
    int RIL_UNSOL_SIM_REFRESH = 1017;								// 0x3f9
    int RIL_UNSOL_CALL_RING = 1018;									// 0x3fa
    int RIL_UNSOL_RESPONSE_SIM_STATUS_CHANGED = 1019;				// 0x3fb
    int RIL_UNSOL_RESPONSE_CDMA_NEW_SMS = 1020;						// 0x3fc
    int RIL_UNSOL_RESPONSE_NEW_BROADCAST_SMS = 1021;				// 0x3fd
    int RIL_UNSOL_CDMA_RUIM_SMS_STORAGE_FULL = 1022;				// 0x3fe
    int RIL_UNSOL_RESTRICTED_STATE_CHANGED = 1023;					// 0x3ff
    int RIL_UNSOL_ENTER_EMERGENCY_CALLBACK_MODE = 1024;				// 0x400
    int RIL_UNSOL_CDMA_CALL_WAITING = 1025;							// 0x401
    int RIL_UNSOL_CDMA_OTA_PROVISION_STATUS = 1026;					// 0x402
    int RIL_UNSOL_CDMA_INFO_REC = 1027;								// 0x403
    int RIL_UNSOL_OEM_HOOK_RAW = 1028;								// 0x404
    int RIL_UNSOL_RINGBACK_TONE = 1029;								// 0x405
    int RIL_UNSOL_RESEND_INCALL_MUTE = 1030;						// 0x406
    int RIL_UNSOL_CDMA_SUBSCRIPTION_SOURCE_CHANGED = 1031;			// 0x407
    int RIL_UNSOl_CDMA_PRL_CHANGED = 1032;							// 0x408
    int RIL_UNSOL_EXIT_EMERGENCY_CALLBACK_MODE = 1033;				// 0x409
    int RIL_UNSOL_RIL_CONNECTED = 1034;								// 0x40a
    int RIL_UNSOL_VOICE_RADIO_TECH_CHANGED = 1035;					// 0x40b
    //int RIL_UNSOL_CELL_INFO_LIST = 1036;
    int RIL_UNSOL_RESPONSE_IMS_NETWORK_STATE_CHANGED = 1036;		// 0x40c
	int RIL_UNSOL_TETHERED_MODE_STATE_CHANGED = 1037;				// 0x40d
	int RIL_UNSOL_DATA_NETWORK_STATE_CHANGED = 1038;				// 0x40e
    int RIL_UNSOL_ON_SS = 1039;										// 0x40f
    int RIL_UNSOL_STK_CC_ALPHA_NOTIFY = 1040;						// 0x410
    int RIL_UNSOL_UICC_SUBSCRIPTION_STATUS_CHANGED = 1041;			// 0x411
